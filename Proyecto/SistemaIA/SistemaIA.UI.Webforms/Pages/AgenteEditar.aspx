<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgenteEditar.aspx.cs" Inherits="SistemaIA.UI.Webforms.Pages.AgenteEditar" %>
    ...
    <div class="container-fluid px-3 px-md-4 py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-dark mb-0">
                <i class="bi bi-robot text-primary me-2"></i>Editar agente
            </h3>
        ...
        <asp:Panel ID="pnlError" runat="server" Visible="false"
            CssClass="alert alert-danger fw-semibold">
        </asp:Panel>

        <div class="card border-0 shadow-sm rounded-3 p-4 bg-white">

            <asp:HiddenField ID="hdnIdAgente" runat="server" />
